...
public class MainServlet extends HttpServlet {
    ...
    private final String PATH_POSTS_WITH_NUMBER_POST = PATH_POSTS + "/\\d+";
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            if (method.equals("GET") && path.matches(PATH_POSTS_WITH_NUMBER_POST)) {
                // easy way
            ...
            if (method.equals("DELETE") && path.matches(PATH_POSTS_WITH_NUMBER_POST)) {
                // easy way
